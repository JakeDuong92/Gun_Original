// Enable weapons on the platform.

using UnityEngine;

namespace Simple2DShooter.Scripts 
{
	public class ShowWeaponsPlatform : MonoBehaviour 
	{
		...
		void BuildPlatform () {
			...
			var getObjsPlatform = GameObject.FindGameObjectsWithTag (GlobalEnvironment.idShowWeaponsTag);
